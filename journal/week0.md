...
- [The Terraform Beginner Bootcamp](#the-terraform-beginner-bootcamp)
- [Streamlining Terraform CLI Setup](#streamlining-terraform-cli-setup)
    - [Automate the Script](#automate-the-script)
    - [Linux Permissions](#linux-permissions)
    - [Considerations](#considerations)
- [Effective Use of Environment Variables](#effective-use-of-environment-variables)
    - [Listing Environment Variables](#listing-environment-variables)
  - [Managing Workspace in Gitpod](#managing-workspace-in-gitpod)
  ...
  - [Create Dotenv](#create-dotenv)
  - [Installation of AWS CLI for Quick Interaction](#installation-of-aws-cli-for-quick-interaction)
    ...
    - [ AWS IAM User Configuration](#3-aws-iam-user-configuration)
      - [Making Environment Variables Persistent in Gitpod](#making-environment-variables-persistent-in-gitpod)
      - [**Security Note: Do Not Leave Credentials in `.env.sample`**](#--security-note--do-not-leave-credentials-in--envsample---)
      - [Verify AWS CLI Authentication](#verify-aws-cli-authentication)
  * [Refining AWS CLI Script](#refining-aws-cli-script)
    + [1. Handling Existing AWS CLI Components](#1-handling-existing-aws-cli-components)
    + [2. Assign Env Vars](#2-assign-env-vars)
    + [3. GPT is Average](#3-gpt-is-average)
- [Terraform Basics](#terraform-basics)
  - [Calling a Provider From Registry](#calling-a-provider-from-registry)
  ...
  * [Terraform Workflow](#terraform-workflow)
    ...
    + [Important Links To Empower You](#important-links-to-empower-you)
- [Provision S3 Using Terraform](#provision-s3-using-terraform)
  - [Try BucketOps](#try-bucketops)
  - [Prerequisites](#prerequisites)
  - [Create an S3 Bucket with Terraform](#create-an-s3-bucket-with-terraform)
    + [Searching for S3 in Terraform Registry](#searching-for-s3-in-terraform-registry)
    + [Define the Terraform Resource](#define-the-terraform-resource)
    + [Configure AWS Provider](#configure-aws-provider)
    + [Initialize and Plan](#initialize-and-plan)
    + [Fixing Bucket Naming Issue](#fixing-bucket-naming-issue)
    + [Re-run Terraform Plan](#re-run-terraform-plan)
...
- [Migrate To Terraform Cloud](#migrate-to-terraform-cloud)
  ...
  * [Why Use Remote State Storage?](#why-use-remote-state-storage-)
  ...
  * [Create a Project](#create-a-project)
    - [Create Your Real Workspace](#create-your-real-workspace)
  * [Code the Cloud Block](#code-the-cloud-block)
    + [RESOLVED: Configure TF Cloud With Gitpod (Token)](#resolved--configure-tf-cloud-with-gitpod--token-)
    + [Simple Test](#simple-test)
    + [`init` is now different.](#-init--is-now-different)
...
- [A Terraformer `tf` Alias](#a-terraformer--tf--alias)
    + [Section 1: Manual Alias Setup](#section-1--manual-alias-setup)
    + [Section 2: Automating Alias Setup with a Bash Script](#section-2--automating-alias-setup-with-a-bash-script)
    + [Section 3: Using the Alias in Gitpod](#section-3--using-the-alias-in-gitpod)
